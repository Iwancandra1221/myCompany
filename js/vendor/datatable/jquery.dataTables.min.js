    ...
    var M = function(g) {
        ...
        function mb(a) {
            var b = a.oClasses,
                ...
                d = a.oPreviousSearch,
                e = a.aanFeatures,
                f = '<input type="search" class="' + b.sFilterInput + '" placeholder="Search ..." style="border:solid 1px #999;border-radius:5px;padding:5px;height:35px;"/>',
                                ...
                                if (g.isArray(q)) {
                                    ...
                                    if (j) {
                                        r = g("<a>", {
                                            ...
                                            "data-dt-idx": m,
                                            "style":"border-radius:5px;background-color:rgba(192,255,255,0.25);border:1px solid #999;",
