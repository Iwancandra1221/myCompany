<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class LaporanPenjualanNasionalv2 extends MY_Controller 
	{
		public $excel_flag = 0;
		...
		public function getDataReport($params)
		{
			...
			// $url = "http://localhost:90/webAPI/LaporanPenjualanNasionalv2/Prosesv2";
			// die($url);
			...
			curl_close($curl);
			// die($response."<br><br>");
	        $response = $this->GzipDecodeModel->_decodeGzip_true($response);
