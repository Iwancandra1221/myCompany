...
<div class="container">
	<h3><center>FOTO BUKTI SCAN QR CODE</center></h3>
	<div class="row">
	...
	<table id="table" class="table table-bordered">
		<thead>
			<tr>
				...
				<th width="15px">JUMLAH FOTO SCAN QR CODE</th>
			...
			success:function(msg){
				if(msg.length>0){
					...
					for(var i =0;i < msg.length;i++)
					{
						...
						row+='<td align="center">'+item.JumlahFotoScan+'</td>';
						row+='<td>'+item.LastUpdate+'</td>';
						row+='<td><a href="ViewFotoScanQRCode?Cabang='+encodeURIComponent(item.CabangMD)+'&NamaMD='+encodeURIComponent(item.NamaMD)+'&fd='+encodeURIComponent(item.JumlahFotoDisplay)+'&awal='+encodeURIComponent(item.TglAwal)+'&akhir='+encodeURIComponent(item.TglAkhir)+'" target="_blank">VIEW</a></td>';
						$('#table').append(row);
