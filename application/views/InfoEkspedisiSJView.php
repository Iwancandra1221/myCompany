  <script>
    ...
    function popupWindow(id){
       window.open('InfoEkspedisiSJCtr/PickTujuan?id=' + encodeURIComponent(id),'popuppage',
    ...
    function updateValue(id, kd_plg, nm_plg, alm_plg)
    {
        ...
        loadSuratJalan(alm_plg);
    }

    function loadSuratJalan(kodegudang){

      $.ajax({
        url : '<?php echo(site_url("RekapEkspedisiSJCtr/GetListSuratJalan?kodetujuan='+kodegudang+'")); ?>',
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          ...
          for(var i=0;i<data.length;i++)
          {
              ...
              var td1="<td>"+data[i]["No_Faktur"]+"<input type='hidden' name='noFaktur_"+i+"' id='noFaktur_"+i+"' value='"+data[i]["No_Faktur"]+"'></td>";
                          
              $("#tblFaktur tbody").append(tr+td0+td1+"</tr>");
          }
  ...
  <div class="container">
    <!-- <form action="InfoEkspedisiSJCtr/UpdateSJ" method="post"> -->
    <?php echo form_open("InfoEkspedisiSJCtr/updateSJ"); ?>
      ...
      <div class="form-group">
        <label>Tujuan</label>
        <input type="text" class="form-control" name="txtTujuan" id="txtTujuan" placeholder="Cabang Tujuan" required readonly>
      ...
      <div class="form-group">
        <label>No Surat Jalan Bhakti</label>
        <table id="tblFaktur" class="table table-striped table-bordered" cellspacing="0" width="100%" summary="table">
          <?php 
            echo "<thead>";
            echo "<tr>";
            echo "</tr>";
