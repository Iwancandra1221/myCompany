...
$sheet->setCellValueByColumnAndRow($currcol, $currrow, 'KODE PENYEBAB');
$currcol ++;
$sheet->setCellValueByColumnAndRow($currcol, $currrow, 'NAMA PENYEBAB');
$currcol ++;
...
$sheet->setCellValueByColumnAndRow($currcol, $currrow, trim($value['kd_penyebab']));
$currcol++;
$sheet->setCellValueByColumnAndRow($currcol, $currrow, trim($value['nm_penyebab']));
$currcol++;
