...
$sheet->setCellValueByColumnAndRow($currcol, $currrow, 'KODE PERBAIKAN');
$currcol ++;
...
$sheet->setCellValueByColumnAndRow($currcol, $currrow, trim($value['kd_perbaikan']));
$currcol++;
$sheet->setCellValueByColumnAndRow($currcol, $currrow, trim($value['nm_perbaikan']));
$currcol++;
