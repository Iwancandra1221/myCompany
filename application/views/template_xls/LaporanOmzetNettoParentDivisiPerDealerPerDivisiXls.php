	...
	foreach($valueTmp as $keyTmp2 => $valueTmp2){
		...
		foreach($valueTmp2 as $keyParentDiv => $valueNmPlg){
			...
			foreach($valueNmPlg as $keyPlg => $valuePlg){
				...
				$row += 1;
				$sheet->setCellValue('A'. $row, $keyPlg);
...
$sheet->setCellValue('B'. $row, $grandGrandGrandTotal2);
$sheet->setCellValue('C'. $row, $grandGrandGrandTotal3);
$sheet->setCellValue('D'. $row, $grandGrandGrandTotal4);
$sheet->setCellValue('E'. $row, $grandGrandGrandTotal5);
$sheet->setCellValue('F'. $row, $grandGrandGrandTotal6);
