...
<div class="container">
	<div class="row">
		<div class="page-title">Master Service Perbaikan</div>
		<div class="col-12">
			<div align="right">
				...
				<a target="_blank" href="<?=base_url()?>Masterservice/perbaikan?export=1"><button type="button" class="btn btn-dark">Export</button></a>
				<?php } ?>
			</div>
		</div>
		<div class="col-12">
			...
			<form id="f-add" method="POST">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Master Service Perbaikan</h5>
					...
					<div class="modal-body">
						<div class="row">
							<!-- <div class="col-3">Kode Perbaikan</div>
							<div class="col-9">
								<input type="text" name="kode" class="form-control">
							</div> -->

							<div class="col-3">Nama Perbaikan</div>
							<div class="col-9">
								<input type="text" name="nama_add" id="nama_add" class="form-control">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function btn_edit(kode,nama,status){
		...
		$("#f-edit input[name='nama_edit']").val(nama);
...
<script>
	...
	$(document).ready(function() {
	    ...
	    $('#table').dataTable( {
	        ...
	        "bServerSide": true,
			"columnDefs": [
			{"title":"Kode Perbaikan","targets": 0, },
			{"title":"Nama Perbaikan","targets": 1,},
	        ...
	        "sAjaxSource": '<?=base_url()?>masterservice/listperbaikan',
	        "oLanguage": {
			        ...
			        "sNext": "Berikutnya"
			            ...
			            function delete_data(e) {
			                if (confirm('Apakah anda yakin ingin hapus?')) {
			                    ...
			                    $.ajax({
			                        type: 'post',
			                        url: '<?php echo site_url('masterservice/perbaikan'); ?>',
			                        data: data,
