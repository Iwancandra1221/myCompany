<?php
//LaporanOmzetNettoParentDivisiPerDealerPerDivisiPdf
?>
<style type="text/css">
	.row {
	    line-height:30px; 
...
<?php
$grandGrandGrandTotal2 = 0;
$grandGrandGrandTotal3 = 0;
$grandGrandGrandTotal4 = 0;
$grandGrandGrandTotal5 = 0;
$grandGrandGrandTotal6 = 0;
foreach($reportTmp as $keyTmp => $valueTmp){
	...
	foreach($valueTmp as $keyTmp2 => $valueTmp2){
		...
		$grandGrandTotal5 = 0;
		$grandGrandTotal6 = 0;
		foreach($valueTmp2 as $keyParentDiv => $valueNmPlg){
			//MK, SR
			echo '<div style="text-align:right;width:100%;font-weight:bold;font-size:18px;">'.$keyParentDiv.'</div>';
			$granTotalCol2 = 0;
			$granTotalCol3 = 0;
			$granTotalCol4 = 0;
			$granTotalCol5 = 0;
			$granTotalCol6 = 0;
			foreach($valueNmPlg as $keyPlg => $valuePlg){
				$tbody = "";
				$totalCol2 = 0;
				$totalCol3 = 0;
				$totalCol4 = 0;
...
HTML;
				...
				echo <<<HTML
				<p>NAMA TOKO : {$keyPlg}</p>
				<table autosize="1" style="overflow: wrap;width:100%;">
					<thead>
						<tr>
							<th style="border:none;width:16.6666666667%;padding: 2mm; text-align: left;">Divisi</th>
					...
					<tfoot>
						<tr>
							<th style="text-align:right;">{$keyPlg}</th>
...
HTML;
			...
			<table autosize="1" style="overflow: wrap;width:100%;">
				<tr>
					<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$keyParentDiv}</th>
...
HTML;
		...
		$grandGrandGrandTotal2 += $grandGrandTotal2;
		$grandGrandGrandTotal3 += $grandGrandTotal3;
		$grandGrandGrandTotal4 += $grandGrandTotal4;
		$grandGrandGrandTotal5 += $grandGrandTotal5;
		$grandGrandGrandTotal6 += $grandGrandTotal6;
		...
		echo <<<HTML
			<table autosize="1" style="overflow: wrap;width:100%;">
				<tr>
					<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$keyTmp2}</th>
...
$grandGrandGrandTotal2 = $grandGrandGrandTotal2 == 0 ? '0' : number_format($grandGrandGrandTotal2,2);
$grandGrandGrandTotal3 = $grandGrandGrandTotal3 == 0 ? '0' : number_format($grandGrandGrandTotal3,2);
$grandGrandGrandTotal4 = $grandGrandGrandTotal4 == 0 ? '0' : number_format($grandGrandGrandTotal4,2);
$grandGrandGrandTotal5 = $grandGrandGrandTotal5 == 0 ? '0' : number_format($grandGrandGrandTotal5,2);
$grandGrandGrandTotal6 = $grandGrandGrandTotal6 == 0 ? '0' : number_format($grandGrandGrandTotal6,2);
echo <<<HTML
	<table autosize="1" style="overflow: wrap;width:100%;">
		<tr>
			<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">Grand Total</th>
			<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$grandGrandGrandTotal2}</th>
			<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$grandGrandGrandTotal3}</th>
			<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$grandGrandGrandTotal4}</th>
			<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$grandGrandGrandTotal5}</th>
			<th style="border-top: solid 1px black;width:16.6666666667%;text-align: right;">{$grandGrandGrandTotal6}</th>
		</tr>
	</table>
	<br>
	<br>
