...
<div class="container">
	...
	<div class="title"><h3>TOLAK RENCANA INTERVENSI PO ?</h3></div>
	<?php echo form_open('PlanPOApproval/Reject', array("id" => "FormPlanPO")); ?>
	<div class="form">
		<div class="po-plan-card">
			<div class="row">
				<div class="col-3 col-m-4 header-row-label">Kode Rencana PO</div>
				<div class="col-5 col-m-4 header-row">
					<input type="text" class="form-control" name="txtKodePlan" id="txtKodePlan" value="<?php echo($PlanNo);?>" style="width:200px;" readonly>
				</div>
