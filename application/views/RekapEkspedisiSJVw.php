    ...
    <!-- <a href="../masterDbCtr">Cancel</a> -->
      <?php echo form_open("RekapEkspedisiSJ/GenerateData");?>
      <!-- <form action="RekapEkspedisiSJCtr/GenerateData" method="post" target="_blank"> -->
        ...
        <div class="form-group">
          ...
          <label for="chkAllTujuan">Pilih Semua Cabang</label>
  ...
  <script>
    ...
    function popupWindow(id){
       window.open('InfoEkspedisiSJ/PickTujuan?id=' + encodeURIComponent(id),'popuppage',
