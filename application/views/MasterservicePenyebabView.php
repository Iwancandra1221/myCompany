...
<div class="container">
	<div class="row">
		<div class="page-title">Master Service Penyebab</div>
		<div class="col-12">
			<div align="right">
				...
				<a target="_blank" href="<?=base_url()?>masterservice/penyebab?export=1">
		...
		<div class="col-12">
			<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th scope="col">Kode Penyebab</th>
						<th scope="col">Nama Penyebab</th>
	...
	<div class="modal fade" id="m-add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<!-- <form id="f-add" action="<?php //echo base_url()?>masterservice/penyebab" method="POST"> -->
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Master Service Penyebab</h5>
					...
					<div class="modal-body">
						<div class="row">
							<!-- <div class="col-3">Kode Penyebab</div>
							<div class="col-9">
								<input type="text" name="kode" class="form-control">
							</div> -->

							<div class="col-3">Nama Penyebab</div>
							<div class="col-9">
					...
					<div class="modal-footer">
						<input type="submit" name="submit" id="addbtn" class="btn btn-dark" value="Tambah">
...
<script>
	...
	$(document).ready(function() {
	    ...
	    $('#table').dataTable( {
	        ...
	        "bServerSide": true,
			"columnDefs": [
			{"title":"Kode Penyebab","targets": 0, },
			{"title":"Nama Penyebab","targets": 1,},
	        ...
	        "sAjaxSource": '<?=base_url()?>masterservice/listpenyebab',
	        "oLanguage": {
			        ...
			        "sNext": "Berikutnya"
			            ...
			            function delete_data(e) {
			                if (confirm('Apakah anda yakin ingin hapus?')) {
			                    ...
			                    $.ajax({
			                        type: 'post',
			                        url: '<?php echo site_url('masterservice/penyebab'); ?>',
			                        data: data,
